...
/* facetednavigation */
if (jQuery("body.template-facetednavigation_view,body.template-configure_faceted-html").length) {
  (function () {
    "use strict";
    ...
    Promise.all([import(/* webpackChunkName: "facetednavigation" */ "./facetednavigation"), import(/* webpackChunkName: "faceted-z3ctable" */ "./faceted-z3ctable")]).then((args) => {
      jQuery(document).ready(function (evt) {
        ...
        if (typeof Faceted !== "undefined") {
          $(Faceted.Events).bind(Faceted.Events.AJAX_QUERY_SUCCESS, function () {
            ...
            Promise.all([import(/* webpackChunkName: "pat-contentloader-bfs" */ "./pattern/pat-contentloader-bfs")]).then((args) => {
...
if (jQuery("body.template-configure_faceted-html").length) {
  (function () {
    ...
    Promise.all([import(/* webpackChunkName: "facetednavigation-edit" */ "./facetednavigation-edit"), import(/* webpackChunkName: "faceted-z3ctable" */ "./faceted-z3ctable-edit")]).then((args) => {
...
if (jQuery("body.portaltype-dpevent").length === 1 || jQuery("body.template-dpevent").length === 1) {
  import("./OpenLayer");
}

// Imports the js/less for popups
if (jQuery("#portal-column-content.bfs_popup").length === 1 || jQuery("body.viewpermission-elan-journal-add-journalentry").length === 1) {
  import("./popup.less");
}
