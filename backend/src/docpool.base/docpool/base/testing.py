...
class LocalBehaviorTestMixin:
    ...
    def setUp_test_apps(self):
        ...
        from docpool.base.appregistry import registerApp, BEHAVIOR_REGISTRY
    ...
    def tearDown_test_apps(self):
        ...
        from docpool.base.appregistry import EXTENSION_REGISTRY, BEHAVIOR_REGISTRY
    ...
    def create_test_dpdocument(self, container=None, local_behaviors=None, doctype=None):
        ...
        if container is None or getattr(container, "portal_type", None) == "DocumentPool":
            ...
            target_docpool = container if container and getattr(container, "portal_type", None) == "DocumentPool" else getattr(self.portal, "bund", None)
            
            if target_docpool and hasattr(target_docpool, "content") and hasattr(target_docpool.content, "Groups"):
