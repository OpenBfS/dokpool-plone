...
var Intercom = (function () {
    ...
    return {
      ...
      off: function (a, c) {
        "undefined" !== typeof this[b] &&
          ...
          i.removeItem(c, this[b][a]);
      },
      trigger: function (a) {
        if ("undefined" !== typeof this[b] && this[b].hasOwnProperty(a))
          for (
            var c = Array.prototype.slice.call(arguments, 1), e = 0;
            e < this[b][a].length;
            e++
          )
            this[b][a][e].apply(this[b][a][e], c);
      },
    };
  };
  ...
  var d = function () {
    ...
    window.attachEvent
      ? document.attachEvent("onstorage", a)
    ...
    var a = this,
      ...
      d = function () {
        if (!c) {
          ...
          s && 1e3 > g - s
            ? (e || (a._on("storage", d), (e = !0)),
              (p = window.setTimeout(d, 20)))
            : ((c = !0),
              f.setItem(l, g),
              b(),
              e && a._off("storage", d),
    ...
    this._transaction(function () {
      for (
        var b = new Date().getTime() - t,
          a = 0,
          c = JSON.parse(f.getItem(j) || "[]"),
          e = c.length - 1;
        0 <= e;
        e--
      )
        c[e].timestamp < b && (c.splice(e, 1), a++);
  ...
  d.prototype._emit = function (b, a, c) {
    if (
      (c = "string" === typeof c || "number" === typeof c ? String(c) : null) &&
      c.length
    ) {
  ...
  d.prototype.once = function (b, a, c) {
    if (d.supported) {
      ...
      this._transaction(function () {
        ...
        e._once_expired(b, d) &&
          ((d[b] = {}),
          (d[b].timestamp = new Date().getTime()),
          "number" === typeof c && (d[b].ttl = 1e3 * c),
          f.setItem(k, JSON.stringify(d)),
          a(),
          window.setTimeout(function () {
            e._cleanup_once();
          }, 50));
  ...
  var r = function (b, a, c) {
    a = i.extend({ id: null, send: !0, receive: !0 }, a);
    if (a.receive) {
      var d = [],
        f = function (f) {
          -1 === d.indexOf(f) &&
