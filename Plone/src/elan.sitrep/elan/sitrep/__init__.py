...
from elan.sitrep import config
...
DocpoolMessageFactory = MessageFactory('elan.sitrep')
...
def initialize(context):
    ...
    from content import srconfig, srscenario, srphase, srmoduleconfig, srcollections, srcollection, srtextblocks, srtextblock, situationoverview, srfolder, srmodule, srmoduletypes, srmoduletype, situationreport    
