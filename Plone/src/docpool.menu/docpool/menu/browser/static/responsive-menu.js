...
(function ($, window, document, Math, undefined) {
  ...
  var Plugin = function (el, options) {
    ...
    o.adjust = function (minWidth) {
      ...
      minWidth =
        typeof minWidth !== "undefined" ? minWidth : o.options.minWidth;

      // Check browser width - set menu layout
      if (typeof Modernizr !== "undefined" && Modernizr.mq("only all")) {
        // MQs supported - Test with Modernizr
        ...
        // Unable to detect MQ support - Test width using outerWidth - less reliable
        if (o.options.developmentMode) {
    ...
    o.layoutExpanded = function () {
      if (!o.container.hasClass(o.expandedClass)) {
        ...
        o.el
          .off("mouseenter.le mouseleave.le")
    ...
    var itemClick = function (e) {
      ...
      if (
        ($el.hasClass(o.itemHoverClass) || !$el.hasClass(o.parentClass)) &&
        !o.touchMoveBool
      ) {
    ...
    var itemFocus = function (e) {
      ...
      o.timer = setTimeout(function () {
        ...
        if (
          o.tButton.hasClass(o.tButtonShowClass) &&
          !o.tButton.hasClass(o.tButtonActiveClass)
        ) {
    ...
    var contract = function ($parent) {
      ...
      if (o.animateBool) {
          ...
          if ($el.height() !== 0) {
            $el
              .css({
                ...
                transition:
                  "max-height " +
                  String(o.options.transitionSpeed / 1000) +
                  "s " +
                  o.options.css3Easing,
                overflow: "hidden",
              })
              .on(
                "transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
                transitionEndContract
              );
          } else {
            $menus.not($el);
          }
        ...
        $menus.each(function () {
          ...
          if ($el.height() !== 0) {
            $el.slideUp(
              o.options.transitionSpeed,
              o.options.jqueryEasing,
              function () {
                $el
