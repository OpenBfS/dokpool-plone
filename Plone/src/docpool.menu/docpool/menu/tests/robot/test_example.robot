...
#
#  $ bin/test -s docpool.menu -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src docpool.menu.testing.DOCPOOL_MENU_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/docpool/menu/tests/robot/test_example.robot
#
