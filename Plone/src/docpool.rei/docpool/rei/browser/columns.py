...
class Metadata(BaseColumn):
    ...
    def renderCell(self, item):
        ...
        title_html = u'<a href="#" class="pat-contentloader-bfs rei-eea-search metatitle" data-pat-contentloader-bfs="content:#row_{0} .rei_title;target:#target_{0}"><div title="Titel auf- bzw. zuklappen" >Open</div></a><h4 class="rei_title" style="display:none">{1}</h4>'.format(item.UID, safe_unicode(obj.Title()))
