...
${TITLE} =  My journal
${DESCRIPTION} =  A journal is a blog post which is intended to provide a rolling textual coverage of an ongoing event.
${TEXT} =  The body
...
Click Add Journal
    Open Add New Menu
    Click Link  css=a#journal
    Page Should Contain  Add Journal
