...
#
#  $ bin/test -s docpool.api -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src docpool.api.testing.DOCPOOL_API_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/docpool/api/tests/robot/test_example.robot
#
