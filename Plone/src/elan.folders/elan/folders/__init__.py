...
from elan.folders import config
...
ELAN_EMessageFactory = MessageFactory('elan.folders')
...
def initialize(context):
    ...
    from content import elanreviewfolder, elancollaborationfolder, elanprivatefolder    
