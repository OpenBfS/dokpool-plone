...
"""Definition of the ELANPrivateFolder content type. See elanprivatefolder.py for more
...
class IELANPrivateFolder(form.Schema, IELANFolder):
    """
    """
...
class ELANPrivateFolder(Container, ELANFolder):
    """
    """
    security = ClassSecurityInfo()
    
    implements(IELANPrivateFolder)
...
##code-section methods
    def createActions(self):
        ...
        placefulWfName = 'elan-private-folder'
...
##/code-section methods 
    ...
    def getELANPrivateFolders(self, **kwargs):
        """
        """
        args = {'portal_type':'ELANPrivateFolder'}
        args.update(kwargs)
        return [obj.getObject() for obj in self.getFolderContents(args)] 
