...
def initialize(context):
    ...
    from content import infofolder, infodocument, infolink, doctypeextension, documentextension, extendable, dpdocument, doctype, simplefolder, contentbase, doctypes, text, folderbase, groupfolder, userfolder, groups, users, reviewfolder, collaborationfolder, privatefolder, documentpool, contentarea, dpapplication, dpconfig    
