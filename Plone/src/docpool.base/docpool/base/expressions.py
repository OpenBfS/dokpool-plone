...
def shared_traverse(base, path_items, request, traverse_method="restrictedTraverse"):
    ...
    while path_items:
        ...
        if ITraversable.providedBy(base):
            ...
            found = traversePathElement(base, name, path_items, request=request)
            ...
            if STRICT_TRAVERSE_CHECK:
                ...
                try:
                    ...
                    if STRICT_TRAVERSE_CHECK == 2:
                        # only warn
                        warnings.warn(
                            "Traversing from {} to {} is only allowed because STRICT_TRAVERSE_CHECK=2. "
...
def traverse(cls, base, request, path_items):
    ...
    result = shared_traverse(
        base, path_items, request, traverse_method=cls.traverse_method
    )
    return result
